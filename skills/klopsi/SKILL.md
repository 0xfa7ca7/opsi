...
| Analyze tabular inputs with bounded read-only SQL, render a small deterministic chart, or convert supported formats. | [klopsi-analysis](../klopsi-analysis/SKILL.md) |
