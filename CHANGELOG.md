...
- Initial complete OPSI CLI and TypeScript SDK: catalogue discovery, secure download/cache, previews, validation, conversion, sandboxed queries, provenance, configuration, diagnostics, completion, WFS access, and multi-format resource workflows.
